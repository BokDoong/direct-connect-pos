...
import karrot.partnerpos.infra.InMemoryPartnerRecordRepository
...
class StoreFinderTest {
    ...
    fun assemblesIntegratedStoreViaJoinPath() {
        ...
        assertThat(store.directPos!!.partner).isSameAs(cj)                     // 데이터→행위 번역 완료
    ...
    fun assemblesNonIntegratedStoreWithoutPartnerContext() {
        ...
        assertThat(store.directPos).isNull()
    }
